          ...
          appBar: commonTopBar(width,height,appbarTitle, widget.subscriber,context),
            /*body:  Container(
              ...
              child:StreamBuilder<QuerySnapshot>(
                ...
                // stream: FirebaseFirestore.instance.collection("Device Manual").snapshots(),
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {

                  if (snapshot.hasError) {
                    return Text('Ityyyy  $Error');
                  }
                  ...
                  List<DocumentSnapshot> lstData = snapshot.data.documents;
                    print('daadda ${lstData.length}');
                    print('daadda ${lstData[1].documentID}');
                  return Container(
                    child: Text(' helloess ${lstData.first.documentID}',style: theme.textTheme.headline6.copyWith(fontWeight: FontWeight.bold,color: CustomColours.darkBlue),),
                  );
