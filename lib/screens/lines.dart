...
class _LinesScreenState extends State<LinesScreen> {
  ...
  double width, height;
  String appbarTitle = 'Account OverVeiw';
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            ...
                                            if (index==1||index==2||index==3) {
                                              servicePeriod = "${lstBuckets[index]?.startAt.substring(0, 10)} - ${lstBuckets[index]?.endAt.substring(0, 10)}";
